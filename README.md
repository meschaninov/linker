...
- Сокращение любого валидного URL
- Кастомное название ссылки (буквы и цифры, до 50 символов)
- Выбор срока действия: 1, 3, 7, 14 дней или без ограничений
- Счётчик переходов: общий и уникальных по IP
- Хранение своих ссылок без регистрации (localStorage)
- Защита удаления через owner token — удалить чужую ссылку невозможно
- Тёмная и светлая тема с анимацией переключения
- Страница 404 для несуществующих и истёкших ссылок

## 🛠️ Технологии

| Часть | Стек |
|-------|------|
| Frontend | Vue 3, Vite, CSS (oklch, View Transitions API) |
